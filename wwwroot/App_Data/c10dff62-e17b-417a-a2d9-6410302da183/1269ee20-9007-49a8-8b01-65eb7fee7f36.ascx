...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <style>
        ...
        .formList li a.form {
            background: url(../images/umbraco/icon_form.gif) no-repeat 2px 2px !important;
        }
    </style>
<% } %>


<script type="text/javascript" src="<% if (CompatibilityHelper.IsVersion7OrNewer){ %>../<% } %>plugins/umbracocontour/scripts/jquery.jfeed.pack.js"></script>
...
<umb:Pane ID="register" runat="server" Text="Register Contour" Visible="false">
    <umb:PropertyPanel ID="PropertyPanel6" runat="server">
        <% if (CompatibilityHelper.IsVersion7OrNewer)
           { %>
            <p>Thank you for trying out Umbraco Contour!</p>
        <% }
           else
           { %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <asp:Panel ID="licensingLogin" runat="server">
                    ...
                    <p>
                        <asp:Button ID="getLicensesButton" runat="server" Text="Get My licenses From umbraco.org" OnClick="getLicensesButton_Click" CssClass="btn"/>  
                    </p>
                    </umb:PropertyPanel>
            </asp:Panel>
...
<umb:Pane ID="createpane" runat="server" Text="Create">
    ...
    <umb:PropertyPanel ID="PropertyPanel5" Text=" " runat="server">
        <p>
            <asp:Button ValidationGroup="create" ID="btnCreate" runat="server" Text="Create" OnClick="btnCreate_Click" CssClass="btn btn-primary"/>
        </p>
    </umb:PropertyPanel>
</umb:Pane>
